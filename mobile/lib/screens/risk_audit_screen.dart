...
import 'package:mobile/services/risk_evaluator.dart';
import 'package:mobile/providers/application_provider.dart';
...
class RiskAuditScreen extends ConsumerWidget {
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: AppTheme.inkPrimary.withValues(alpha: 0.05), blurRadius: 20, offset: const Offset(0, 10))],
                  ),
                  child: Column(
                    children: [
                      Text(
  ...
  Widget _buildFactorTile(BuildContext context, String text, bool isPositive) {
    return Container(
      margin: const EdgeInsetsDirectional.only(bottom: AppTheme.espacioEntreGrupos),
