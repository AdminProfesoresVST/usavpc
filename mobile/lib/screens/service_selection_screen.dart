                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        l10n.heroSubtitle,
                        style: AppTheme.bodyWhiteRegular.copyWith(color: AppTheme.inkInverse.withValues(alpha: 0.7), fontSize: AppTheme.fuenteLabel),
                        maxLines: 1, 
                  ...
                  child: Row(
                    children: [
                      _StepItem(
                        ...
                        isFirst: true,
                        onTap: () => context.push('/services/help/scan'),
                      ),
                      ...
                      _StepItem(
                        ...
                        onTap: () => context.push('/services/help/simulate'),
                      ),
                      const SizedBox(width: 8),
                      _StepItem(
                        ...
                        isLast: true,
                         onTap: () => context.push('/services/help/results'),
                      ),
                    ],
                  ),
                ),
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        ...
                        style: AppTheme.h2NavyBold.copyWith(fontSize: AppTheme.fuenteLabel),
                      ),
                    ],
                  ),
                ),
                  ...
                  child: Column(
                    children: [
                      ...
                      _ServiceCard(
                        ...
                        onTap: () => _handleNavigation(context, ref, '/services/visa/select'),
                      ),
                      ...
                      _ServiceCard(
                        ...
                        onTap: () => _handleNavigation(context, ref, '/services/quick-check'),
                      ),
                      ...
                      _ServiceCard(
                        ...
                        onTap: () => _handleNavigation(context, ref, '/services/cost/calculate'),
                      ),
                      ...
                      _ServiceCard(
                        ...
                        onTap: () => _handleNavigation(context, ref, '/services/travel-ban/check'),
                      ),
                    ],
                  ),
                ),
                ...
                Center(
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(Icons.lock, size: AppTheme.iconoPequeno, color: AppTheme.successGreen),
                        const SizedBox(width: 4),
                        Text(
                          l10n.securityNote,
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: Text(
                              title,
                              style: AppTheme.h2NavyBold.copyWith(fontSize: AppTheme.fuenteLabel), // Reduced font
                            ),
                          ),
                          if (badgeText != null)
                            Container(
