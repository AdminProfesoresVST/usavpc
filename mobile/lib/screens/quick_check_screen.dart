...
import 'package:mobile/core/utils/visa_localization_helper.dart';
                ...
                builder: (context, ref, _) {
                  ...
                  return categoriesAsync.when(
                    ...
                    error: (e, _) => Container(
                      ...
                      child: Text(l10n.error(e.toString()), style: TextStyle(color: AppTheme.errorRed)),
                    ),
                    data: (categories) {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: selected ? AppTheme.navyPrimary.withValues(alpha: 0.05) : AppTheme.inkInverse,
          border: Border.all(
