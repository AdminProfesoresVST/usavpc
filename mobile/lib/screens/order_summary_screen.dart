...
import 'package:mobile/providers/payments_provider.dart';
  ...
  Future<void> _processPayment(double total, String planTitle) async {
    ...
    try {
      ...
      if (response.status != 200) {
        throw Exception(l10n.error(response.data.toString()));
      }
      ...
      await Stripe.instance.initPaymentSheet(
        paymentSheetParameters: SetupPaymentSheetParameters(
          ...
          merchantDisplayName: 'USA Visa Center', // Consider adding to l10n if this should be localized
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: AppTheme.espacioEntreLabelInput),
                    Text(
                      l10n.securePayment,
